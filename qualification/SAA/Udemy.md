...
## EC2（1:48,63）（2:8） [2:5,40] [3:1,10,18,36] [4:1,30] [5:15]
...
## VPC （2:36,48）[1:58] [2:34] [3:34] [4:4,16] [5:32]
  * [X] ルートテーブル
...
## S3（1:12,24,30,36,61）（2:13,14,15,18,25,40,41,49）[1:4,37,49,64] [2:14,21,36,50] [3:33,64] [4:7,24] [5:2,3,27,63]
...
## RDS（1:10,32）[1:14,16] [2:43] [3:32,35] [4:8] [5:20]
  * RDS Proxy
